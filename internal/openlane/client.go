...
type GraphAPI interface {
	...
	GetPlatforms(ctx context.Context, first *int64, after *string, where *graphclient.PlatformWhereInput) (*graphclient.GetPlatforms, error)
	GetPlatformByID(ctx context.Context, id string) (*graphclient.GetPlatformByID, error)
	GetPlatformDetail(ctx context.Context, id string) (*PlatformDetail, error)
	CreatePlatform(ctx context.Context, input graphclient.CreatePlatformInput, diagrams PlatformDiagramUploads) (*PlatformDetail, error)
	UpdatePlatform(ctx context.Context, id string, input graphclient.UpdatePlatformInput, diagrams PlatformDiagramUploads) (*PlatformDetail, error)
